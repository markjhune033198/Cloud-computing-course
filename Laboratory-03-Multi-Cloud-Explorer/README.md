...
This laboratory explores three major cloud computing platforms: Amazon Web Services (AWS), Microsoft Azure, and Google Cloud Platform (GCP). The activity focuses on comparing cloud services, analyzing business requirements, recommending cloud platforms, and investigating Linux environments.
...
The Linux operating system information was collected using:
...
Mem:           1.9Gi       412Mi       872Mi       1.1Mi       786Mi       1.5Gi
Swap:          1.0Gi          0B       1.0Gi
root@ubuntu:~$ df -h
